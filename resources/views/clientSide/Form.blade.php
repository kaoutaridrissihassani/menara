...
<html lang="en">
    ...
    <body class="p-5 m-5" style="width: 90%; background-color: #80808017;">
       ...
       <span id="message_error"></span>
        ...
        <!-- Form - START -->
        <form id="validate" class="ml-25 border rounded m-5 p-5" style="width: 100%; background-color: white;" method="POST" enctype="multipart/form-data" action="{{ route('stageaire.questionnaire') }}">
            @csrf
